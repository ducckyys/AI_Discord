...
export const commands: Command[] = [askCommand, resetCommand, modelCommand, memoryCommand, statusCommand, pingCommand, helpCommand, inviteCommand, aboutCommand, configCommand, reloadCommand, shutdownCommand];
