...
import { pingCommand } from "../commands/utility/ping.js"; import { helpCommand } from "../commands/utility/help.js"; import { inviteCommand } from "../commands/utility/invite.js"; import { aboutCommand } from "../commands/utility/about.js";
...
export const commands: Command[] = [askCommand, resetCommand, modelCommand, memoryCommand, pingCommand, helpCommand, inviteCommand, aboutCommand, configCommand, reloadCommand, shutdownCommand];
