import { SlashCommandBuilder, EmbedBuilder } from "discord.js"; import type { Command } from "../../interfaces/command.js"; import { colors } from "../../utils/colors.js";
  ...
  async execute(i) {
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: "Creator", value: "Duck / duckkyy_", inline: false },
        { name: "Support", value: "Need help or want to contribute? Open an issue in the repo or message Duck on Discord.", inline: false },
      )
