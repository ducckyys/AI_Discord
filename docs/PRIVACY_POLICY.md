...
Duccky AI does not send prompts to OpenAI or any other cloud AI provider. Information may be accessible to the operator and to infrastructure providers selected by the operator, such as a database host, server host, or externally hosted SearXNG instance.
